...
export function RestTimer({
  ...
  return (
    <div className="fixed-below-status fixed left-4 right-4 z-[105] mx-auto max-w-md rounded-md border border-gray-200 bg-white px-4 py-3 md:left-auto md:right-8">
