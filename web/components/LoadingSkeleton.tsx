...
export function WorkoutCardSkeleton() {
  return (
    <div className="mb-4 animate-pulse rounded-md border border-gray-100 bg-white p-5">
...
export function StatCardSkeleton() {
  return (
    <div className="animate-pulse rounded-md border border-gray-100 bg-white p-4">
