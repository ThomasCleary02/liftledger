...
type Props = {
  ...
  closeText?: string;
  /** Custom footer. Pass `null` to hide the default Done bar. */
  footer?: React.ReactNode | null;
};

/** Full-screen overlay on document.body, sized to visualViewport so iOS chrome cannot cover actions. */
export function FullScreenSheet({
  ...
  const footerContent = showDefaultFooter ? (
