    ...
    <div>
      ...
      {sets.map((set, idx) => (
        <div key={idx} className="mb-2 flex items-center gap-2">
          ...
          <input
            type="number"
            className="flex-1 rounded-lg bg-gray-100 px-3 py-2.5 text-sm outline-none transition-all focus:bg-white focus:ring-2 focus:ring-black"
            value={set.reps}
          ...
          <div className="relative flex-1">
            <input
              type="number"
              className="w-full rounded-lg bg-gray-100 px-3 py-2.5 pr-12 text-sm outline-none transition-all focus:bg-white focus:ring-2 focus:ring-black"
              value={set.weight}
